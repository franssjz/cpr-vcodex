...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Toggle(StrId::STR_AUTO_TIME_SYNC, &CrossPointSettings::autoTimeSyncEnabled, "autoTimeSyncEnabled",
                          StrId::STR_APPS),
      SettingInfo::Value(StrId::STR_AUTO_TIME_SYNC_INTERVAL, &CrossPointSettings::autoTimeSyncIntervalHours, {1, 48, 1},
                         "autoTimeSyncIntervalHours", StrId::STR_APPS),
      SettingInfo::Enum(
      ...
      SettingInfo::Enum(StrId::STR_DAILY_GOAL, &CrossPointSettings::dailyGoalTarget,
                        {StrId::STR_MIN_15, StrId::STR_MIN_30, StrId::STR_MIN_45, StrId::STR_MIN_60}, "dailyGoalTarget",
                        StrId::STR_APPS),
