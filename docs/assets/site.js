(() => {
  ...
  const messages = {
    en: {
      ...
      cableText: "Connect the Xteink to your computer. If no serial port appears, wake and unlock the device, then reconnect it. On a frozen X4 Pro, hold the upper/previous-page side button (GPIO0), press and release Reset, then release the side button to enter the ESP32-S3 ROM bootloader and select its USB JTAG/Serial port.",
    ...
    es: {
      ...
      cableText: "Conecta el Xteink al ordenador. Si no aparece el puerto serie, despierta y desbloquea el dispositivo y vuelve a conectarlo. En un X4 Pro bloqueado, mantén pulsado el botón lateral superior/página anterior (GPIO0), pulsa y suelta Reset y después suelta el botón lateral para entrar en el bootloader ROM ESP32-S3; selecciona su puerto USB JTAG/Serial.",
  ...
  Object.assign(messages, {
    ...
    pt: {
      ...
      homeSubtitle: "Pequenas ferramentas de navegador para CPR-vCodex no Xteink X3, X4 e X4 Pro. Tudo roda localmente no seu navegador.", latestFirmware: "Firmware mais recente: 1.6.0.31-cpr-vcodex", homeStats: "Editor de estatísticas",
      flashEyebrow: "Instalador no navegador", flashTitle: "Gravar CPR-vCodex", flashSubtitle: "Instale o firmware CPR-vCodex mais recente no seu Xteink X3, X4 ou X4 Pro pelo Chrome ou Edge usando Web Serial. A página grava a partição de app inativa e muda o boot para ela.",
      ...
      cableTitle: "Use um cabo USB-C de dados", cableText: "Conecte o Xteink ao computador. Em um X4 Pro travado, mantenha pressionado o botão lateral superior/página anterior (GPIO0), pressione e solte Reset e depois solte o botão lateral para entrar no bootloader ROM do ESP32-S3; selecione a nova porta USB JTAG/Serial.",
      browserTitle: "Use Chrome ou Edge no desktop", browserText: "Firefox e Safari não suportam Web Serial. O navegador pedirá para escolher a porta serial USB do Xteink: ESP32-C3 no X3/X4 ou ESP32-S3 no X4 Pro.",
      unplugTitle: "Não desconecte durante o flash", unplugText: "A página valida a tabela de partições, grava o slot OTA inativo e atualiza <code>otadata</code>. No X4 Pro, siga a instrução de reinicialização manual ao terminar.",
      deviceModelText: "Escolha o modelo exato antes de gravar. X3 e X4 compartilham uma imagem ESP32-C3; o X4 Pro usa sua própria imagem ESP32-S3. A página verifica o chip conectado antes de escrever.",
