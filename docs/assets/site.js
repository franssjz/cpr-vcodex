(() => {
  ...
  const messages = {
    en: {
      ...
      homeSubtitle: "Firmware, auto-flash and local browser tools for CPR-vCodex on Xteink X3 and X4.",
      ...
      flashSubtitle: "Install the latest CPR-vCodex firmware on your Xteink X3 or X4 from Chrome or Edge using Web Serial. X4 Pro flashing is currently disabled.",
      ...
      deviceX4ProUnsupported: "X4 Pro flashing is disabled while a reported post-update boot failure is investigated.",
      deviceX4ProBridgeWarning: "Do not install CPR-vCodex on X4 Pro until this notice is removed.",
    ...
    es: {
      ...
      homeSubtitle: "Firmware, Auto Flash y herramientas locales de navegador para CPR-vCodex en Xteink X3 y X4.",
      ...
      flashSubtitle: "Instala el último firmware CPR-vCodex en tu Xteink X3 o X4 desde Chrome o Edge usando Web Serial. El flasheo de X4 Pro está desactivado.",
      ...
      deviceX4ProUnsupported: "El flasheo de X4 Pro está desactivado mientras se investiga un fallo de arranque posterior a la actualización.",
      deviceX4ProBridgeWarning: "No instales CPR-vCodex en X4 Pro hasta que se retire este aviso.",
