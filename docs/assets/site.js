(() => {
  ...
  const messages = {
    en: {
      ...
      homeSubtitle: "Firmware, auto-flash and local browser tools for CPR-vCodex on Xteink X3, X4 and X4 Pro.",
      latestFirmware: "Latest firmware: 1.5.0.30-cpr-vcodex",
      ...
      flashSubtitle: "Install the latest CPR-vCodex firmware on your Xteink X3, X4 or X4 Pro from Chrome or Edge using Web Serial. It writes the inactive app partition and then switches boot to it.",
      ...
      cableText: "Connect the Xteink X3, X4 or X4 Pro to your computer. If no serial port appears, wake and unlock the device, then reconnect it.",
      browserTitle: "Use Chrome or Edge on desktop",
      browserText: "Firefox and Safari do not support Web Serial. The browser will ask you to choose the USB serial port for the selected device.",
      ...
      deviceModelText: "Choose the exact model before flashing. The flasher validates the partition table before writing.",
      deviceX4: "Xteink X4",
      deviceX3: "Xteink X3",
      deviceX4Pro: "Xteink X4 Pro",
      deviceX4ProStatus: "ESP32-S3 · 7.9 MB OTA slot",
      deviceX4ProUnsupported: "X4 Pro uses a separate ESP32-S3 firmware asset. The option is enabled only when the current release manifest includes that build.",
      deviceX4ProBridgeWarning: "If your X4 Pro is already on 1.5.0.28, update to 1.5.0.29 with this browser flasher once; on-device OTA selects the X4 Pro asset from 1.5.0.29 onward.",
      ...
      choosePort: "Choose the selected device serial port in the browser prompt.",
      ...
      firmwareBuildUnavailable: "No firmware asset is available for {device} in the current release manifest.",
      partitionUnsupportedX4Pro: "Xteink X4 Pro detected. Select X4 Pro so the ESP32-S3 firmware is used.",
    ...
    es: {
      ...
      homeSubtitle: "Firmware, Auto Flash y herramientas locales de navegador para CPR-vCodex en Xteink X3, X4 y X4 Pro.",
      latestFirmware: "Último firmware: 1.5.0.30-cpr-vcodex",
      homeFlash: "Auto Flash",
      ...
      flashSubtitle: "Instala el último firmware CPR-vCodex en tu Xteink X3, X4 o X4 Pro desde Chrome o Edge usando Web Serial. Escribe la partición de app inactiva y luego arranca desde ella.",
      ...
      cableText: "Conecta el Xteink X3, X4 o X4 Pro al ordenador. Si no aparece el puerto serie, despierta y desbloquea el dispositivo y vuelve a conectarlo.",
      browserTitle: "Usa Chrome o Edge en escritorio",
      browserText: "Firefox y Safari no soportan Web Serial. El navegador te pedirá elegir el puerto USB serie del dispositivo seleccionado.",
      ...
      deviceModelText: "Elige el modelo exacto antes de flashear. La página valida la tabla de particiones antes de escribir.",
      deviceX4: "Xteink X4",
      deviceX3: "Xteink X3",
      deviceX4Pro: "Xteink X4 Pro",
      deviceX4ProStatus: "ESP32-S3 · slot OTA 7,9 MB",
      deviceX4ProUnsupported: "X4 Pro usa un asset de firmware ESP32-S3 separado. La opción se activa solo cuando el manifest de la release actual incluye ese build.",
      deviceX4ProBridgeWarning: "Si tu X4 Pro ya está en 1.5.0.28, actualiza una vez a 1.5.0.29 con este flasher del navegador; el OTA del dispositivo selecciona el asset X4 Pro desde 1.5.0.29 en adelante.",
      ...
      choosePort: "Elige el puerto serie del dispositivo seleccionado en el aviso del navegador.",
      ...
      firmwareBuildUnavailable: "No hay asset de firmware disponible para {device} en el manifest de la release actual.",
  ...
  Object.assign(messages, {
    ca: {
      ...
      homeSubtitle: "Petites eines de navegador per a CPR-vCodex. Tot s'executa localment al navegador.", latestFirmware: "Últim firmware: 1.5.0.30-cpr-vcodex", homeStats: "Editor d'estadístiques",
    ...
    fr: {
      ...
      homeSubtitle: "Petits outils de navigateur pour CPR-vCodex. Tout s'exécute localement dans votre navigateur.", latestFirmware: "Dernier firmware : 1.5.0.30-cpr-vcodex", homeStats: "Éditeur de statistiques",
    ...
    de: {
      ...
      homeSubtitle: "Kleine Browser-Tools für CPR-vCodex. Alles läuft lokal in Ihrem Browser.", latestFirmware: "Neueste Firmware: 1.5.0.30-cpr-vcodex", homeStats: "Statistik-Editor",
    ...
    it: {
      ...
      homeSubtitle: "Piccoli strumenti browser per CPR-vCodex. Tutto viene eseguito localmente nel browser.", latestFirmware: "Firmware più recente: 1.5.0.30-cpr-vcodex", homeStats: "Editor statistiche",
    ...
    pt: {
      ...
      homeSubtitle: "Pequenas ferramentas de navegador para CPR-vCodex. Tudo roda localmente no seu navegador.", latestFirmware: "Firmware mais recente: 1.5.0.30-cpr-vcodex", homeStats: "Editor de estatísticas",
    ...
    nl: {
      ...
      homeSubtitle: "Kleine browsertools voor CPR-vCodex. Alles draait lokaal in je browser.", latestFirmware: "Nieuwste firmware: 1.5.0.30-cpr-vcodex", homeStats: "Statistiekeditor",
  ...
  Object.assign(messages, {
    be: {
      navHome: "Галоўная", navStats: "Рэдактар статыстыкі", darkMode: "Цёмны рэжым", lightMode: "Светлы рэжым", homeSubtitle: "Невялікія браузерныя інструменты для CPR-vCodex. Усё працуе лакальна ў вашым браузеры.", latestFirmware: "Апошняя прашыўка: 1.5.0.30-cpr-vcodex", homeStats: "Рэдактар статыстыкі",
    ...
    kk: {
      navHome: "Басты бет", navStats: "Статистика редакторы", darkMode: "Қараңғы режим", lightMode: "Жарық режим", homeSubtitle: "CPR-vCodex үшін шағын браузер құралдары. Барлығы браузерде жергілікті орындалады.", latestFirmware: "Соңғы firmware: 1.5.0.30-cpr-vcodex", homeStats: "Статистика редакторы",
    ...
    si: {
      navHome: "Domov", navStats: "Urejevalnik statistik", darkMode: "Temni način", lightMode: "Svetli način", homeSubtitle: "Majhna brskalniška orodja za CPR-vCodex. Vse teče lokalno v brskalniku.", latestFirmware: "Najnovejši firmware: 1.5.0.30-cpr-vcodex", homeStats: "Urejevalnik statistik",
  ...
  Object.assign(messages, {
    hu: {
      navHome: "Kezdőlap", navStats: "Statisztika szerkesztő", darkMode: "Sötét mód", lightMode: "Világos mód", homeSubtitle: "Kis böngészős eszközök a CPR-vCodexhez. Minden helyben fut a böngésződben.", latestFirmware: "Legújabb firmware: 1.5.0.30-cpr-vcodex", homeStats: "Statisztika szerkesztő",
    ...
    lt: {
      navHome: "Pradžia", navStats: "Statistikos redaktorius", darkMode: "Tamsus režimas", lightMode: "Šviesus režimas", homeSubtitle: "Maži naršyklės įrankiai CPR-vCodex. Viskas veikia lokaliai jūsų naršyklėje.", latestFirmware: "Naujausia programinė įranga: 1.5.0.30-cpr-vcodex", homeStats: "Statistikos redaktorius",
    ...
    ro: {
      navHome: "Acasă", navStats: "Editor statistici", darkMode: "Mod întunecat", lightMode: "Mod luminos", homeSubtitle: "Mici unelte de browser pentru CPR-vCodex. Totul rulează local în browser.", latestFirmware: "Cel mai nou firmware: 1.5.0.30-cpr-vcodex", homeStats: "Editor statistici",
    ...
    sv: {
      navHome: "Hem", navStats: "Statistikredigerare", darkMode: "Mörkt läge", lightMode: "Ljust läge", homeSubtitle: "Små webbläsarverktyg för CPR-vCodex. Allt körs lokalt i din webbläsare.", latestFirmware: "Senaste firmware: 1.5.0.30-cpr-vcodex", homeStats: "Statistikredigerare",
    ...
    tr: {
      navHome: "Ana sayfa", navStats: "İstatistik düzenleyici", darkMode: "Karanlık mod", lightMode: "Aydınlık mod", homeSubtitle: "CPR-vCodex için küçük tarayıcı araçları. Her şey tarayıcınızda yerel çalışır.", latestFirmware: "En son firmware: 1.5.0.30-cpr-vcodex", homeStats: "İstatistik düzenleyici",
    ...
    uk: {
      navHome: "Головна", navStats: "Редактор статистики", darkMode: "Темний режим", lightMode: "Світлий режим", homeSubtitle: "Невеликі браузерні інструменти для CPR-vCodex. Усе працює локально у браузері.", latestFirmware: "Остання прошивка: 1.5.0.30-cpr-vcodex", homeStats: "Редактор статистики",
    ...
    vi: {
      navHome: "Trang chủ", navStats: "Trình sửa thống kê", darkMode: "Chế độ tối", lightMode: "Chế độ sáng", homeSubtitle: "Các công cụ trình duyệt nhỏ cho CPR-vCodex. Mọi thứ chạy cục bộ trong trình duyệt của bạn.", latestFirmware: "Firmware mới nhất: 1.5.0.30-cpr-vcodex", homeStats: "Trình sửa thống kê",
  ...
  Object.assign(messages, {
    cs: {
      navHome: "Domů", navStats: "Editor statistik", darkMode: "Tmavý režim", lightMode: "Světlý režim", homeSubtitle: "Malé nástroje v prohlížeči pro CPR-vCodex. Vše běží lokálně ve vašem prohlížeči.", latestFirmware: "Nejnovější firmware: 1.5.0.30-cpr-vcodex", homeStats: "Editor statistik",
    ...
    da: {
      navHome: "Hjem", navStats: "Statistikeditor", darkMode: "Mørk tilstand", lightMode: "Lys tilstand", homeSubtitle: "Små browserværktøjer til CPR-vCodex. Alt kører lokalt i din browser.", latestFirmware: "Nyeste firmware: 1.5.0.30-cpr-vcodex", homeStats: "Statistikeditor",
      ...
      navHome: "Etusivu", navStats: "Tilastoeditori", darkMode: "Tumma tila", lightMode: "Vaalea tila", homeSubtitle: "Pieniä selaintyökaluja CPR-vCodexille. Kaikki toimii paikallisesti selaimessasi.", latestFirmware: "Uusin firmware: 1.5.0.30-cpr-vcodex", homeStats: "Tilastoeditori",
    ...
    pl: {
      navHome: "Start", navStats: "Edytor statystyk", darkMode: "Tryb ciemny", lightMode: "Tryb jasny", homeSubtitle: "Małe narzędzia przeglądarkowe dla CPR-vCodex. Wszystko działa lokalnie w przeglądarce.", latestFirmware: "Najnowszy firmware: 1.5.0.30-cpr-vcodex", homeStats: "Edytor statystyk",
    ...
    ru: {
      navHome: "Главная", navStats: "Редактор статистики", darkMode: "Тёмный режим", lightMode: "Светлый режим", homeSubtitle: "Небольшие браузерные инструменты для CPR-vCodex. Всё работает локально в браузере.", latestFirmware: "Последняя прошивка: 1.5.0.30-cpr-vcodex", homeStats: "Редактор статистики",
