(() => {
  ...
  const messages = {
    en: {
      ...
      homeSubtitle: "Firmware and browser tools for CPR-vCodex on the Xteink X4 and X3. X4 Pro distribution is withdrawn.",
      latestFirmware: "Latest firmware: 1.6.0.31-cpr-vcodex",
      ...
      flashSubtitle: "Install the latest CPR-vCodex firmware on your Xteink X4 or X3 from Chrome or Edge using Web Serial. X4 Pro distribution is withdrawn.",
      ...
      cableText: "Connect the Xteink X4 or X3 to your computer. If no serial port appears, wake and unlock the device, then reconnect it.",
      browserTitle: "Use Chrome or Edge on desktop",
      browserText: "Firefox and Safari do not support Web Serial. The browser will ask you to choose the ESP32-C3 USB serial port of the X4 or X3.",
      ...
      deviceModelText: "Choose X4 or X3 before flashing. They share one ESP32-C3 image with different OTA slot sizes. X4 Pro firmware is not distributed.",
      deviceX4: "Xteink X4",
      deviceX3: "Xteink X3",
      ...
      deviceX4ProBlocked: "Firmware withdrawn · flashing blocked",
      x4ProDistributionWarning: "Do not install CPR-vCodex on X4 Pro. Its binaries and flashing paths are withdrawn while locked-device recovery is investigated.",
      ...
      firmwareWithdrawn: "Withdrawn for safety",
    ...
    es: {
      ...
      homeSubtitle: "Firmware y herramientas de navegador para CPR-vCodex en Xteink X4 y X3. La distribución para X4 Pro está retirada.",
      latestFirmware: "Último firmware: 1.6.0.31-cpr-vcodex",
      homeFlash: "Auto Flash",
      ...
      flashSubtitle: "Instala el último firmware CPR-vCodex en tu Xteink X4 o X3 desde Chrome o Edge usando Web Serial. La distribución para X4 Pro está retirada.",
      ...
      cableText: "Conecta el Xteink X4 o X3 al ordenador. Si no aparece el puerto serie, despierta y desbloquea el dispositivo y vuelve a conectarlo.",
      browserTitle: "Usa Chrome o Edge en escritorio",
      browserText: "Firefox y Safari no soportan Web Serial. El navegador te pedirá elegir el puerto USB serie ESP32-C3 del X4 o X3.",
      ...
      deviceModelText: "Elige X4 o X3 antes de flashear. Comparten una imagen ESP32-C3 con slots OTA de distinto tamaño. No se distribuye firmware para X4 Pro.",
      deviceX4: "Xteink X4",
      deviceX3: "Xteink X3",
      deviceX4Pro: "Xteink X4 Pro",
      ...
      deviceX4ProBlocked: "Firmware retirado · flasheo bloqueado",
      x4ProDistributionWarning: "No instales CPR-vCodex en X4 Pro. Sus binarios y rutas de flasheo están retirados mientras se investiga la recuperación de dispositivos bloqueados.",
      ...
      firmwareWithdrawn: "Retirado por seguridad",
  ...
  Object.assign(messages, {
    ca: {
      ...
      homeSubtitle: "Petites eines de navegador per a CPR-vCodex. Tot s'executa localment al navegador.", latestFirmware: "Últim firmware: 1.6.0.31-cpr-vcodex", homeStats: "Editor d'estadístiques",
    ...
    fr: {
      ...
      homeSubtitle: "Petits outils de navigateur pour CPR-vCodex. Tout s'exécute localement dans votre navigateur.", latestFirmware: "Dernier firmware : 1.6.0.31-cpr-vcodex", homeStats: "Éditeur de statistiques",
    ...
    de: {
      ...
      homeSubtitle: "Kleine Browser-Tools für CPR-vCodex. Alles läuft lokal in Ihrem Browser.", latestFirmware: "Neueste Firmware: 1.6.0.31-cpr-vcodex", homeStats: "Statistik-Editor",
    ...
    it: {
      ...
      homeSubtitle: "Piccoli strumenti browser per CPR-vCodex. Tutto viene eseguito localmente nel browser.", latestFirmware: "Firmware più recente: 1.6.0.31-cpr-vcodex", homeStats: "Editor statistiche",
    ...
    pt: {
      ...
      homeSubtitle: "Firmware e ferramentas de navegador para CPR-vCodex no Xteink X3 e X4. A distribuição para X4 Pro foi retirada.", latestFirmware: "Firmware mais recente: 1.6.0.31-cpr-vcodex", homeStats: "Editor de estatísticas",
      flashEyebrow: "Instalador no navegador", flashTitle: "Gravar CPR-vCodex", flashSubtitle: "Instale o firmware CPR-vCodex mais recente no seu Xteink X3 ou X4 pelo Chrome ou Edge usando Web Serial. A distribuição para X4 Pro foi retirada.",
      ...
      cableTitle: "Use um cabo USB-C de dados", cableText: "Conecte o Xteink X3 ou X4 ao computador. Se nenhuma porta serial aparecer, desperte e desbloqueie o aparelho e reconecte-o.",
      browserTitle: "Use Chrome ou Edge no desktop", browserText: "Firefox e Safari não suportam Web Serial. O navegador pedirá a porta serial USB ESP32-C3 do X3 ou X4.",
      unplugTitle: "Não desconecte durante o flash", unplugText: "A página valida a tabela de partições, grava o slot OTA inativo, atualiza <code>otadata</code> e reinicia o aparelho ao terminar.",
      deviceModelText: "Escolha X3 ou X4 antes de gravar. Eles compartilham uma imagem ESP32-C3 com slots OTA diferentes. O firmware do X4 Pro não é distribuído.",
      deviceX4: "Xteink X4", deviceX3: "Xteink X3", deviceX4Pro: "Xteink X4 Pro",
      deviceX4Slot: "ESP32-C3 · slot OTA de 6,5 MB", deviceX3Slot: "ESP32-C3 · slot OTA de 7,8 MB", deviceX4ProSlot: "ESP32-S3 · slot OTA de 8,2 MB",
      deviceX4ProBlocked: "Firmware retirado · gravação bloqueada", x4ProDistributionWarning: "Não instale CPR-vCodex no X4 Pro. Os binários e métodos de gravação foram retirados enquanto a recuperação de aparelhos bloqueados é investigada.",
      deviceX4ProNote: "X4 Pro: depois que o flash terminar, desconecte e reconecte o cabo USB e mantenha Power pressionado até o aparelho iniciar.",
      latestPackage: "Pacote de firmware mais recente", firmwareWithdrawn: "Retirado por segurança", flashWarning: "Use por sua conta e risco. Gravar firmware personalizado pode falhar se o cabo desconectar ou o dispositivo perder energia.",
      ...
      flashButton: "Gravar firmware CPR-vCodex", flashing: "Gravando...", readyStatus: "Pronto. Clicar em Flash abrirá o seletor de dispositivo serial do navegador.", choosePort: "Escolha a porta serial USB do chip correspondente no prompt do navegador.",
      ...
      flashComplete: "Flash concluído. O dispositivo deve reiniciar no CPR-vCodex.", flashCompleteX4Pro: "Flash concluído. No X4 Pro, desconecte e reconecte o cabo USB e mantenha Power pressionado até o CPR-vCodex iniciar.", resetManualX4Pro: "Reinicialização manual necessária no X4 Pro: desconecte e reconecte o USB e mantenha Power pressionado.", flashStopped: "Flash interrompido. Verifique a mensagem acima antes de tentar de novo.", downloadBin: "Baixar .bin", communityFlasher: "Flasher da comunidade",
    ...
    nl: {
      ...
      homeSubtitle: "Kleine browsertools voor CPR-vCodex. Alles draait lokaal in je browser.", latestFirmware: "Nieuwste firmware: 1.6.0.31-cpr-vcodex", homeStats: "Statistiekeditor",
  ...
  Object.assign(messages, {
    be: {
      navHome: "Галоўная", navStats: "Рэдактар статыстыкі", darkMode: "Цёмны рэжым", lightMode: "Светлы рэжым", homeSubtitle: "Невялікія браузерныя інструменты для CPR-vCodex. Усё працуе лакальна ў вашым браузеры.", latestFirmware: "Апошняя прашыўка: 1.6.0.31-cpr-vcodex", homeStats: "Рэдактар статыстыкі",
    ...
    kk: {
      navHome: "Басты бет", navStats: "Статистика редакторы", darkMode: "Қараңғы режим", lightMode: "Жарық режим", homeSubtitle: "CPR-vCodex үшін шағын браузер құралдары. Барлығы браузерде жергілікті орындалады.", latestFirmware: "Соңғы firmware: 1.6.0.31-cpr-vcodex", homeStats: "Статистика редакторы",
    ...
    si: {
      navHome: "Domov", navStats: "Urejevalnik statistik", darkMode: "Temni način", lightMode: "Svetli način", homeSubtitle: "Majhna brskalniška orodja za CPR-vCodex. Vse teče lokalno v brskalniku.", latestFirmware: "Najnovejši firmware: 1.6.0.31-cpr-vcodex", homeStats: "Urejevalnik statistik",
  ...
  Object.assign(messages, {
    hu: {
      navHome: "Kezdőlap", navStats: "Statisztika szerkesztő", darkMode: "Sötét mód", lightMode: "Világos mód", homeSubtitle: "Kis böngészős eszközök a CPR-vCodexhez. Minden helyben fut a böngésződben.", latestFirmware: "Legújabb firmware: 1.6.0.31-cpr-vcodex", homeStats: "Statisztika szerkesztő",
    ...
    lt: {
      navHome: "Pradžia", navStats: "Statistikos redaktorius", darkMode: "Tamsus režimas", lightMode: "Šviesus režimas", homeSubtitle: "Maži naršyklės įrankiai CPR-vCodex. Viskas veikia lokaliai jūsų naršyklėje.", latestFirmware: "Naujausia programinė įranga: 1.6.0.31-cpr-vcodex", homeStats: "Statistikos redaktorius",
    ...
    ro: {
      navHome: "Acasă", navStats: "Editor statistici", darkMode: "Mod întunecat", lightMode: "Mod luminos", homeSubtitle: "Mici unelte de browser pentru CPR-vCodex. Totul rulează local în browser.", latestFirmware: "Cel mai nou firmware: 1.6.0.31-cpr-vcodex", homeStats: "Editor statistici",
    ...
    sv: {
      navHome: "Hem", navStats: "Statistikredigerare", darkMode: "Mörkt läge", lightMode: "Ljust läge", homeSubtitle: "Små webbläsarverktyg för CPR-vCodex. Allt körs lokalt i din webbläsare.", latestFirmware: "Senaste firmware: 1.6.0.31-cpr-vcodex", homeStats: "Statistikredigerare",
    ...
    tr: {
      navHome: "Ana sayfa", navStats: "İstatistik düzenleyici", darkMode: "Karanlık mod", lightMode: "Aydınlık mod", homeSubtitle: "CPR-vCodex için küçük tarayıcı araçları. Her şey tarayıcınızda yerel çalışır.", latestFirmware: "En son firmware: 1.6.0.31-cpr-vcodex", homeStats: "İstatistik düzenleyici",
    ...
    uk: {
      navHome: "Головна", navStats: "Редактор статистики", darkMode: "Темний режим", lightMode: "Світлий режим", homeSubtitle: "Невеликі браузерні інструменти для CPR-vCodex. Усе працює локально у браузері.", latestFirmware: "Остання прошивка: 1.6.0.31-cpr-vcodex", homeStats: "Редактор статистики",
    ...
    vi: {
      navHome: "Trang chủ", navStats: "Trình sửa thống kê", darkMode: "Chế độ tối", lightMode: "Chế độ sáng", homeSubtitle: "Các công cụ trình duyệt nhỏ cho CPR-vCodex. Mọi thứ chạy cục bộ trong trình duyệt của bạn.", latestFirmware: "Firmware mới nhất: 1.6.0.31-cpr-vcodex", homeStats: "Trình sửa thống kê",
  ...
  Object.assign(messages, {
    cs: {
      navHome: "Domů", navStats: "Editor statistik", darkMode: "Tmavý režim", lightMode: "Světlý režim", homeSubtitle: "Malé nástroje v prohlížeči pro CPR-vCodex. Vše běží lokálně ve vašem prohlížeči.", latestFirmware: "Nejnovější firmware: 1.6.0.31-cpr-vcodex", homeStats: "Editor statistik",
    ...
    da: {
      navHome: "Hjem", navStats: "Statistikeditor", darkMode: "Mørk tilstand", lightMode: "Lys tilstand", homeSubtitle: "Små browserværktøjer til CPR-vCodex. Alt kører lokalt i din browser.", latestFirmware: "Nyeste firmware: 1.6.0.31-cpr-vcodex", homeStats: "Statistikeditor",
      ...
      navHome: "Etusivu", navStats: "Tilastoeditori", darkMode: "Tumma tila", lightMode: "Vaalea tila", homeSubtitle: "Pieniä selaintyökaluja CPR-vCodexille. Kaikki toimii paikallisesti selaimessasi.", latestFirmware: "Uusin firmware: 1.6.0.31-cpr-vcodex", homeStats: "Tilastoeditori",
    ...
    pl: {
      navHome: "Start", navStats: "Edytor statystyk", darkMode: "Tryb ciemny", lightMode: "Tryb jasny", homeSubtitle: "Małe narzędzia przeglądarkowe dla CPR-vCodex. Wszystko działa lokalnie w przeglądarce.", latestFirmware: "Najnowszy firmware: 1.6.0.31-cpr-vcodex", homeStats: "Edytor statystyk",
    ...
    ru: {
      navHome: "Главная", navStats: "Редактор статистики", darkMode: "Тёмный режим", lightMode: "Светлый режим", homeSubtitle: "Небольшие браузерные инструменты для CPR-vCodex. Всё работает локально в браузере.", latestFirmware: "Последняя прошивка: 1.6.0.31-cpr-vcodex", homeStats: "Редактор статистики",
